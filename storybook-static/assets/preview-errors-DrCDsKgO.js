import{d as i}from"./index-ogSvIofg.js";let e;const r=new Uint8Array(16);function d(){if(!e&&(e=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!e))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return e(r)}const n=[];for(let E=0;E<256;++E)n.push((E+256).toString(16).slice(1));function s(E,t=0){return n[E[t+0]]+n[E[t+1]]+n[E[t+2]]+n[E[t+3]]+"-"+n[E[t+4]]+n[E[t+5]]+"-"+n[E[t+6]]+n[E[t+7]]+"-"+n[E[t+8]]+n[E[t+9]]+"-"+n[E[t+10]]+n[E[t+11]]+n[E[t+12]]+n[E[t+13]]+n[E[t+14]]+n[E[t+15]]}const u=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),o={randomUUID:u};function p(E,t,m){if(o.randomUUID&&!E)return o.randomUUID();E=E||{};const R=E.random||(E.rng||d)();return R[6]=R[6]&15|64,R[8]=R[8]&63|128,s(R)}var c=class extends Error{constructor(){super(...arguments),this.data={},this.documentation=!1,this.fromStorybook=!0}get fullErrorCode(){let E=String(this.code).padStart(4,"0");return`SB_${this.category}_${E}`}get name(){let E=this.constructor.name;return`${this.fullErrorCode} (${E})`}get message(){let E;return this.documentation===!0?E=`https://storybook.js.org/error/${this.fullErrorCode}`:typeof this.documentation=="string"?E=this.documentation:Array.isArray(this.documentation)&&(E=`
