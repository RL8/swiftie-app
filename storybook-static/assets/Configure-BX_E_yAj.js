...
implementation in one place.`}),e.jsxs("a",{href:"https://storybook.js.org/docs/sharing/design-integrations/?renderer=svelte#embed-storybook-in-figma-with-the-plugin",target:"_blank",children:["Learn more",e.jsx(s,{})]})]}),e.jsxs("div",{className:"sb-grid-item",children:[e.jsx("img",{src:C,alt:"Screenshot of tests passing and failing"}),e.jsx("h4",{className:"sb-section-item-heading",children:"Testing"}),e.jsx("p",{className:"sb-section-item-paragraph",children:`Use stories to test a component in all its variations, no matter how\r
...
`,e.jsx("style",{children:`
  ...
  `})]})}function N(t={}){const{wrapper:i}=Object.assign({},o(),t.components);return i?e.jsx(i,Object.assign({},t,{children:e.jsx(r,t)})):r(t)}export{s as RightArrow,N as default};
